      ...
      <div>
        <Tabs defaultValue="mobile-money" className="w-full">
          ...
          <TabsContent value="mobile-money">
            <Card>
              <CardHeader>
                <CardTitle>Paiement temporairement indisponible</CardTitle>
                <CardDescription>
                  L'intégration MaxiCash doit être mise à niveau avant de pouvoir accepter des paiements en toute sécurité.
                </CardDescription>
              </CardHeader>
              <CardContent>
